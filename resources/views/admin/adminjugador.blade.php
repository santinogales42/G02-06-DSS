...
@section('content')
<div class="container">
    <h1 class="titulo-admin-jugadores"> Administración de Jugadores</h1>
    ...
    function fetchData(page = 1) {
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                <td>
                <button onclick="openEditModal(${jugador.id})" class="btn boton-editar"><i class="fas fa-pencil-alt"></i></button>
