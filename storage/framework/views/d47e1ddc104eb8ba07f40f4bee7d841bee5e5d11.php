...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <a href="<?php echo e(route('threads.create')); ?>" class="btn btn-primary mb-3">Crear un Hilo</a>
        ...
        <?php echo $__env->make('threads.thread_list', ['threads' => $threads], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchThreads() {
        ...
        fetch(`<?php echo e(url('/threads/search')); ?>?search=${searchTerm}&showMy=false`)
    ...
    fetch(`<?php echo e(url('/toggleThreads')); ?>?showMy=${showMyThreads}`)
    .then(response => {
        if (response.status === 401) { // Si el usuario no está autenticado
            window.location.href = "<?php echo e(route('login')); ?>"; // Redirige al usuario a la página de inicio de sesión
        }
    ...
    function handleDelete() {
        if (confirm('¿Estás seguro de querer eliminar este hilo?')) {
            ...
            fetch(`<?php echo e(route('threads.destroy', '')); ?>/${threadId}`, {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/usuario/Escritorio/DSS/G02-06-DSS/resources/views/threads/index.blade.php ENDPATH**/ ?>