...
<body>
    <div class="banner">
        <img src="<?php echo e(asset('images/tims.png')); ?>" alt="Banner" class="img-fluid" usemap="#equiposMap" style="width:100%;">
        <map name="equiposMap">
    ...
    <div class="w3-sidebar w3-card w3-animate-left" style="display:none" id="mySidebar">
        <div class="SidebarSection">
            ...
            <a href="<?php echo e(route('home')); ?>" class="w3-bar-item w3-button icon-link" style="text-decoration: none; margin-left: 20px; margin-right: 20px;">
                <i class="fa-solid fa-house"></i> Inicio
            </a>
            <a href="<?php echo e(route('noticias')); ?>" class="w3-bar-item w3-button icon-link" style="text-decoration: none; margin-left: 20px; margin-right: 20px;">
                <i class="fa-solid fa-newspaper"></i> Noticias
            </a>
            <a href="<?php echo e(route('equipos.index')); ?>" class="w3-bar-item w3-button icon-link" style="text-decoration: none; margin-left: 20px; margin-right: 20px;">
                <i class="fa-solid fa-users"></i> Equipos
            </a>
            <a href="<?php echo e(route('jugadores')); ?>" class="w3-bar-item w3-button icon-link" style="text-decoration: none; margin-left: 20px; margin-right: 20px;">
                <i class="fa-solid fa-user"></i> Jugadores
            </a>
            <a href="<?php echo e(route('calendario.index')); ?>" class="w3-bar-item w3-button icon-link" style="text-decoration: none; margin-left: 20px; margin-right: 20px;">
                <i class="fa-regular fa-calendar fa-lg"></i> Calendario
            </a>
            <a href="<?php echo e(route('threads.index')); ?>" class="w3-bar-item w3-button icon-link" style="text-decoration: none; margin-left: 20px; margin-right: 20px;">
                <i class="fa-solid fa-hashtag"></i> Foro
            </a>

            <a href="<?php echo e(route('clasificacion')); ?>" class="w3-bar-item w3-button icon-link" style="text-decoration: none; margin-left: 20px; margin-right: 20px;">
                <i class="fa-solid fa-chart-line"></i> Clasificación
            </a> 
           
            <?php if(auth()->guard()->check()): ?>
            <?php if(Auth::check() && (Auth::user()->role->name === 'admin'||Auth::user()->role->name === 'noticiero'||Auth::user()->role->name === 'analista')): ?>
            <a href="<?php echo e(route('admin.index')); ?>" class="w3-bar-item w3-button icon-link" style="text-decoration: none; margin-left: 20px; margin-right: 20px;">
            ...
            <div class="SidebarDownSection">
                ...
                <div class="contenedor-imagenes">
                    <img src="<?php echo e(asset('images/insta.png')); ?>" alt="Imagen 1" class="img-fluid">
                    <img src="<?php echo e(asset('images/face.png')); ?>" alt="Imagen 2" class="img-fluid">
                    <img src="<?php echo e(asset('images/twit.png')); ?>" alt="Imagen 3" class="img-fluid">
                </div>
            </div>
        </div>
    ...
    <div id="main">
        <header class="w3-teal" style="display: flex; align-items: center; padding: 0 15px;">
            ...
            <img src="<?php echo e(asset('images/ligaicono.png')); ?>" alt="Logo La Liga" class="title-logo" style="border: 2px solid red; margin-right: 20px; flex-shrink: 0;">
            <h1 class="roboto-flex-title" style="flex-grow: 1; text-align: center;">LALIGA EA SPORTS 2023-24</h1>
            <a href="<?php echo e(route('contacto')); ?>" class=" btn btn-outline-light mr-2 ">Contáctanos</a>
            ...
            <div class="navbar-text" style="display: flex; align-items: center;">
                <div class="w3-dropdown-hover" id="userDropdown">
                    <button class="w3-button w3-bar-item" id="userButton">
                        ...
                        <img src="<?php echo e(asset('images/usuario_r.png')); ?>" alt="Perfil" class="user-icon" class="img-fluid">
                        <i class="fas fa-chevron-down"></i>
                    </button>
                    <div class="w3-dropdown-content w3-bar-block w3-card" id="dropdownContent-cerrarSesion">
                        <a href="<?php echo e(route('perfilUsuario.index')); ?>" class="w3-bar-item w3-button" style="text-decoration: none;">Mi Perfil</a>
                        <a href="<?php echo e(route('favoritos.index')); ?>" class="w3-bar-item w3-button">Favoritos</a>
                        <a href="<?php echo e(route('confirmar.cerrar.sesion')); ?>" class="w3-bar-item w3-button" id="logoutButton">Cerrar sesión</a>
            ...
            <div class="navbar-text" style="display: flex; align-items: center;">
                <a class="btn btn-outline-light ml-auto" href="<?php echo e(route('register')); ?>">Registrarse</a>
                <a class="btn btn-light ml-2" href="<?php echo e(route('login')); ?>">Iniciar Sesión</a>
            </div>
            <?php endif; ?>
        </header>
        <div class="content">
    ...
    </script><?php /**PATH /home/usuario/Escritorio/DSS/G02-06-DSS/resources/views/layout.blade.php ENDPATH**/ ?>